import PageTitle from "@/components/modules/Tours/PageTitle";
...
export default function Tours() {
  ...
  const {data: divisionData} = useGetDivisionsQuery({_id: division});
  
  // console.log(divisionDataObject);
  const pageInfo: IPageInfo = {
    pageTitle: `Tours in ${divisionData?.[0]?.name}`,
    pageDescription: divisionData?.[0]?.description,
    pageImage: divisionData?.[0]?.thumbnail
  }
